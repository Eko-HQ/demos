...
Follow `prompts/integrate_demo.md` from the containing Eko workspace. Add the client folder and one matching script in `package.json`. Keep all client-specific files inside that folder, use subpath-safe relative asset URLs, and preserve every existing integration.
